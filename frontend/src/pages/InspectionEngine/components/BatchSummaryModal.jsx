            ...
            (() => {
              ...
              if (batch.tasks) {
                batch.tasks.forEach(task => {
                  ...
                  // Calculate questions from MasterList parameters OR directly from ratings array (for fixed Roadway parameters)
                  const questionsList = (task.parameters && task.parameters.length > 0) ? task.parameters : (task.ratings || []);
                ...
                <>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-8">
                    ...
                    <div className="bg-orange-50 rounded-xl p-4 border border-orange-200 flex flex-col justify-center relative overflow-hidden">
                      ...
                      <p className="text-[10px] font-bold text-orange-600 uppercase tracking-wider mb-1 z-10">Day Questions</p>
                    ...
                    <div className="bg-indigo-50 rounded-xl p-4 border border-indigo-200 flex flex-col justify-center relative overflow-hidden">
                      ...
                      <p className="text-[10px] font-bold text-indigo-600 uppercase tracking-wider mb-1 z-10">Night Questions</p>
                      ...
                      <tbody className="divide-y divide-gray-100">
                        {batch.tasks?.slice(0, 50).map(task => (
                          <tr key={task._id}>
                            ...
                            <td className="px-4 py-2 text-gray-600">{task.assetType || task.parameters?.[0]?.assetType || 'N/A'}</td>
                            ...
                            <td className="px-4 py-2 text-gray-600 font-bold">{(task.ratings?.length > 0 ? task.ratings.length : task.parameters?.length) || 0} Params</td>
                            <td className="px-4 py-2">
